...
Public Class rptlaporprice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptlaporprice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlaporprice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlaporprice = New rptlaporprice()
        rpt.Site = Me.Site
        Return rpt
    End Function
