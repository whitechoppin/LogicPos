...
Public Class fakturlunaspiutang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturlunaspiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfakturlunaspiutang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturlunaspiutang = New fakturlunaspiutang()
        rpt.Site = Me.Site
        Return rpt
    End Function
