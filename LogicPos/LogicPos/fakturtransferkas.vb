...
Public Class fakturtransferkas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturtransferkas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kekas() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedfakturtransferkas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturtransferkas = New fakturtransferkas()
        rpt.Site = Me.Site
        Return rpt
    End Function
