...
Public Class fakturexpedisi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturexpedisi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfakturexpedisi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturexpedisi = New fakturexpedisi()
        rpt.Site = Me.Site
        Return rpt
    End Function
