...
Public Class rptrekapkaskeluar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptrekapkaskeluar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptrekapkaskeluar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrekapkaskeluar = New rptrekapkaskeluar()
        rpt.Site = Me.Site
        Return rpt
    End Function
