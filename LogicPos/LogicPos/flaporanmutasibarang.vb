        ...
        If cbperiode.Checked = True Then
                    ...
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                ...
                                UNION
                                (SELECT 'PENYESUAIAN' AS tabel, tb_penyesuaian_stok.id AS id, kode_barang, kode_stok, nama_barang, IF(STRCMP(status_stok,'MINUS') = 0, (qty * -1), qty * 1) AS qty, tb_penyesuaian_stok.gudang_id AS dari_gudang, tb_penyesuaian_stok.gudang_id AS ke_gudang, tb_penyesuaian_stok.tanggal_penyesuaian_stok AS tanggal FROM tb_penyesuaian_stok_detail JOIN tb_penyesuaian_stok ON tb_penyesuaian_stok_detail.penyesuaian_stok_id = tb_penyesuaian_stok.id)
            ...
            Else
                ...
                If cmbbarang.Text.Length > 0 Then
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                UNION
                                (SELECT 'TRANSFER' AS tabel, tb_transfer_barang_detail.transfer_barang_id as id, kode_barang, kode_stok, nama_barang, qty, tb_transfer_barang.dari_gudang_id as dari_gudang, tb_transfer_barang.ke_gudang_id as ke_gudang, tb_transfer_barang.tanggal_transfer_barang as tanggal FROM tb_transfer_barang_detail JOIN tb_transfer_barang ON tb_transfer_barang_detail.transfer_barang_id = tb_transfer_barang.idWHERE DATE(tb_transfer_barang.tanggal_transfer_barang) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND dari_gudang_id='" & cmbgudang.SelectedValue & "') 
                                UNION
                                (SELECT 'PENYESUAIAN' AS tabel, tb_penyesuaian_stok.id AS id, kode_barang, kode_stok, nama_barang, IF(STRCMP(status_stok,'MINUS') = 0, (qty * -1), qty * 1) AS qty, tb_penyesuaian_stok.gudang_id AS dari_gudang, tb_penyesuaian_stok.gudang_id AS ke_gudang, tb_penyesuaian_stok.tanggal_penyesuaian_stok AS tanggal FROM tb_penyesuaian_stok_detail JOIN tb_penyesuaian_stok ON tb_penyesuaian_stok_detail.penyesuaian_stok_id = tb_penyesuaian_stok.id)
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                    ...
                    Else
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                UNION
                                (SELECT 'TRANSFER' AS tabel, tb_transfer_barang_detail.transfer_barang_id as id, kode_barang, kode_stok, nama_barang, qty, tb_transfer_barang.dari_gudang_id as dari_gudang, tb_transfer_barang.ke_gudang_id as ke_gudang, tb_transfer_barang.tanggal_transfer_barang as tanggal FROM tb_transfer_barang_detail JOIN tb_transfer_barang ON tb_transfer_barang_detail.transfer_barang_id = tb_transfer_barang.idWHERE DATE(tb_transfer_barang.tanggal_transfer_barang) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND dari_gudang_id='" & cmbgudang.SelectedValue & "') 
                                UNION
                                (SELECT 'PENYESUAIAN' AS tabel, tb_penyesuaian_stok.id AS id, kode_barang, kode_stok, nama_barang, IF(STRCMP(status_stok,'MINUS') = 0, (qty * -1), qty * 1) AS qty, tb_penyesuaian_stok.gudang_id AS dari_gudang, tb_penyesuaian_stok.gudang_id AS ke_gudang, tb_penyesuaian_stok.tanggal_penyesuaian_stok AS tanggal FROM tb_penyesuaian_stok_detail JOIN tb_penyesuaian_stok ON tb_penyesuaian_stok_detail.penyesuaian_stok_id = tb_penyesuaian_stok.id)
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "')
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "')
                                UNION 
                    ...
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                UNION
                                (SELECT 'TRANSFER' AS tabel, tb_transfer_barang_detail.transfer_barang_id as id, kode_barang, kode_stok, nama_barang, qty, tb_transfer_barang.dari_gudang_id as dari_gudang, tb_transfer_barang.ke_gudang_id as ke_gudang, tb_transfer_barang.tanggal_transfer_barang as tanggal FROM tb_transfer_barang_detail JOIN tb_transfer_barang ON tb_transfer_barang_detail.transfer_barang_id = tb_transfer_barang.idWHERE DATE(tb_transfer_barang.tanggal_transfer_barang) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND dari_gudang_id='" & cmbgudang.SelectedValue & "') 
                                UNION
                                (SELECT 'PENYESUAIAN' AS tabel, tb_penyesuaian_stok.id AS id, kode_barang, kode_stok, nama_barang, IF(STRCMP(status_stok,'MINUS') = 0, (qty * -1), qty * 1) AS qty, tb_penyesuaian_stok.gudang_id AS dari_gudang, tb_penyesuaian_stok.gudang_id AS ke_gudang, tb_penyesuaian_stok.tanggal_penyesuaian_stok AS tanggal FROM tb_penyesuaian_stok_detail JOIN tb_penyesuaian_stok ON tb_penyesuaian_stok_detail.penyesuaian_stok_id = tb_penyesuaian_stok.id)
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                    ...
                    Else
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                UNION
                                (SELECT 'TRANSFER' AS tabel, tb_transfer_barang_detail.transfer_barang_id as id, kode_barang, kode_stok, nama_barang, qty, tb_transfer_barang.dari_gudang_id as dari_gudang, tb_transfer_barang.ke_gudang_id as ke_gudang, tb_transfer_barang.tanggal_transfer_barang as tanggal FROM tb_transfer_barang_detail JOIN tb_transfer_barang ON tb_transfer_barang_detail.transfer_barang_id = tb_transfer_barang.idWHERE DATE(tb_transfer_barang.tanggal_transfer_barang) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND dari_gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION
                                (SELECT 'PENYESUAIAN' AS tabel, tb_penyesuaian_stok.id AS id, kode_barang, kode_stok, nama_barang, IF(STRCMP(status_stok,'MINUS') = 0, (qty * -1), qty * 1) AS qty, tb_penyesuaian_stok.gudang_id AS dari_gudang, tb_penyesuaian_stok.gudang_id AS ke_gudang, tb_penyesuaian_stok.tanggal_penyesuaian_stok AS tanggal FROM tb_penyesuaian_stok_detail JOIN tb_penyesuaian_stok ON tb_penyesuaian_stok_detail.penyesuaian_stok_id = tb_penyesuaian_stok.id)
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' )
                                ...
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS dari_gudang, tb_barang_masuk.gudang_id AS ke_gudang , tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' )
                                UNION 
