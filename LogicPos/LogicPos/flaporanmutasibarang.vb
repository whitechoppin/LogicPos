    ...
    Sub tabel()
        ...
        If cbperiode.Checked = True Then
                ...
                If cmbbarang.Text.Length > 0 Then
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT 'KELUAR' AS tabel, tb_barang_keluar_detail.barang_keluar_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_keluar.gudang_id AS dari_gudang, tb_barang_keluar.gudang_id AS ke_gudang, tb_barang_keluar.tgl_barang_keluar AS tanggal FROM tb_barang_keluar_detail JOIN tb_barang_keluar ON tb_barang_keluar_detail.barang_keluar_id = tb_barang_keluar.id WHERE DATE(tb_barang_keluar.tgl_barang_keluar)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION
            ...
            Else
                ...
                If cmbbarang.Text.Length > 0 Then
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                    ...
                    Else
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "')
                                UNION 
                ...
                Else
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                    ...
                    Else
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' )
                                UNION 
        ...
        Else
            ...
            If cmbbarang.Text.Length > 0 Then
                If cmbstok.Text.Length > 0 Then
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
            ...
            Else
                If cmbstok.Text.Length > 0 Then
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE kode_stok='" & cmbstok.Text & "')
                                UNION 
                ...
                Else
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id WHERE gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, qty, tb_penjualan.gudang_id AS dari_gudang, tb_penjualan.gudang_id AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.id )
                                UNION 
