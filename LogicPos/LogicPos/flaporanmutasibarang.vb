...
Public Class flaporanmutasibarang
    ...
    Sub grid()
        ...
        GridColumn5.Caption = "Kode Gudang"
        GridColumn5.FieldName = "kode_gudang"

        GridColumn6.Caption = "Tanggal Transaksi"
    ...
    Sub tabel()
                ...
                If cmbstok.Text.Length > 0 Then
                    ...
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE DATE(tb_barang_masuk.tgl_barang_masuk)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                ...
                Else
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND Kode_barang='" & cmbbarang.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE DATE(tb_barang_masuk.tgl_barang_masuk)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND Kode_barang='" & cmbbarang.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                    ...
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND Kode_barang='" & cmbbarang.Text & "')
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE DATE(tb_barang_masuk.tgl_barang_masuk)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND Kode_barang='" & cmbbarang.Text & "')
                                UNION 
                ...
                If cmbstok.Text.Length > 0 Then
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE DATE(tb_barang_masuk.tgl_barang_masuk)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                    ...
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE DATE(tb_barang_masuk.tgl_barang_masuk)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                ...
                Else
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_gudang='" & cmbgudang.Text & "')
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE DATE(tb_barang_masuk.tgl_barang_masuk)='" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                    ...
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE DATE(tb_penjualan.tgl_penjualan)='" & Format(dtawal.Value, "yyyy-MM-dd") & "')
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE DATE(tb_barang_masuk.tgl_barang_masuk)='" & Format(dtawal.Value, "yyyy-MM-dd") & "')
                                UNION 
        ...
        Else
            ...
            If cmbbarang.Text.Length > 0 Then
                If cmbstok.Text.Length > 0 Then
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                ...
                Else
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "')
                                UNION 
            ...
            Else
                If cmbstok.Text.Length > 0 Then
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                ...
                Else
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY )
                                UNION 
                                ...
                                UNION 
                                (SELECT tb_barang_masuk_detail.kode_barang_masuk AS kode_tabel, kode_barang, kode_stok, qty, tb_barang_masuk.kode_gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.kode_barang_masuk = tb_barang_masuk.kode_barang_masuk WHERE tb_barang_masuk.tgl_barang_masuk BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY )
                                UNION 
