...
Public Class flaporanmutasibarang
    ...
    Sub grid()
        ...
        GridColumn5.Caption = "Dari Gudang"
        GridColumn5.FieldName = "dari_gudang"

        GridColumn6.Caption = "Ke Gudang"
        GridColumn6.FieldName = "ke_gudang"

        GridColumn7.Caption = "Tanggal Transaksi"
        GridColumn7.FieldName = "tanggal"
        GridColumn7.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Custom
        GridColumn7.DisplayFormat.FormatString = "dd/MM/yyyy"
    ...
    Sub tabel()
        ...
        Else
            ...
            If cmbbarang.Text.Length > 0 Then
                If cmbstok.Text.Length > 0 Then
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                ...
                Else
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND Kode_barang='" & cmbbarang.Text & "')
                                UNION 
            ...
            Else
                If cmbstok.Text.Length > 0 Then
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_stok='" & cmbstok.Text & "' AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                ...
                Else
                    If cmbgudang.Text.Length > 0 Then
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY AND kode_gudang='" & cmbgudang.Text & "')
                                UNION 
                                ...
                                ORDER BY tanggal ASC"
                    Else
                        sql = "(SELECT tb_penjualan.kode_penjualan AS kode_tabel, kode_barang, kode_stok, qty, tb_penjualan.kode_gudang AS dari_gudang, tb_penjualan.kode_gudang AS ke_gudang , tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.kode_penjualan = tb_penjualan.kode_penjualan WHERE tb_penjualan.tgl_penjualan BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' + INTERVAL 1 DAY )
                                UNION 
