        ...
        If cbperiode.Checked = True Then
            ...
            Else
                ...
                If cmbbarang.Text.Length > 0 Then
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                        ...
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                    ...
                    Else
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                        ...
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "')
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "')
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_barang='" & cmbbarang.Text & "')
                                UNION 
                    ...
                    If cmbstok.Text.Length > 0 Then
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                        ...
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND kode_stok='" & cmbstok.Text & "')
                                UNION 
                    ...
                    Else
                        If cmbgudang.Text.Length > 0 Then
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' AND gudang_id='" & cmbgudang.SelectedValue & "')
                                UNION 
                        ...
                        Else
                            sql = "(SELECT 'JUAL' AS tabel, tb_penjualan.id as id, kode_barang, kode_stok, nama_barang, (qty * -1) AS qty, tb_penjualan.gudang_id AS gudang, tb_penjualan.tgl_penjualan AS tanggal FROM tb_penjualan_detail JOIN tb_penjualan ON tb_penjualan_detail.penjualan_id = tb_penjualan.idWHERE DATE(tb_penjualan.tgl_penjualan) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' )
                                UNION 
                                (SELECT 'BELI' AS tabel, tb_pembelian.id as id, kode_barang, kode_stok, nama_barang, qty, tb_pembelian.gudang_id AS gudang, tb_pembelian.tgl_pembelian AS tanggal FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian_detail.pembelian_id = tb_pembelian.idWHERE DATE(tb_pembelian.tgl_pembelian) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' )
                                UNION 
                                (SELECT 'MASUK' AS tabel, tb_barang_masuk_detail.barang_masuk_id as id, kode_barang, kode_stok, nama_barang, qty, tb_barang_masuk.gudang_id AS gudang, tb_barang_masuk.tgl_barang_masuk AS tanggal FROM tb_barang_masuk_detail JOIN tb_barang_masuk ON tb_barang_masuk_detail.barang_masuk_id = tb_barang_masuk.idWHERE DATE(tb_barang_masuk.tgl_barang_masuk) BETWEEN '" & Format(dtawal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtakhir.Value, "yyyy-MM-dd") & "' )
                                UNION 
