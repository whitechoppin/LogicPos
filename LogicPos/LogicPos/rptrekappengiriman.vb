...
Public Class rptrekappengiriman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptrekappengiriman.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptrekappengiriman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrekappengiriman = New rptrekappengiriman()
        rpt.Site = Me.Site
        Return rpt
    End Function
