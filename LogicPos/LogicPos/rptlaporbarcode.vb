...
Public Class rptlaporbarcode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptlaporbarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlaporbarcode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlaporbarcode = New rptlaporbarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
