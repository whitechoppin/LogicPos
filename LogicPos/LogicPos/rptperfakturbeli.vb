...
Public Class rptperfakturbeli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptperfakturbeli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptperfakturbeli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptperfakturbeli = New rptperfakturbeli()
        rpt.Site = Me.Site
        Return rpt
    End Function
