...
Public Class rptperfakturreturjual
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptperfakturreturjual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptperfakturreturjual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptperfakturreturjual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptperfakturreturjual = New rptperfakturreturjual()
        rpt.Site = Me.Site
        Return rpt
    End Function
