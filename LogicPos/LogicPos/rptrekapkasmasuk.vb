...
Public Class rptrekapkasmasuk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptrekapkasmasuk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptrekapkasmasuk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrekapkasmasuk = New rptrekapkasmasuk()
        rpt.Site = Me.Site
        Return rpt
    End Function
