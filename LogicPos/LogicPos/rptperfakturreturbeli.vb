...
Public Class rptperfakturreturbeli
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptperfakturreturbeli.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptperfakturreturbeli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptperfakturreturbeli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptperfakturreturbeli = New rptperfakturreturbeli()
        rpt.Site = Me.Site
        Return rpt
    End Function
