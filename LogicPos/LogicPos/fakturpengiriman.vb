...
Public Class fakturpengiriman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturpengiriman.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_teleponexpedisi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedfakturpengiriman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturpengiriman = New fakturpengiriman()
        rpt.Site = Me.Site
        Return rpt
    End Function
