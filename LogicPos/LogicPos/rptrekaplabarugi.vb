...
Public Class rptrekaplabarugi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptrekaplabarugi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptrekaplabarugi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrekaplabarugi = New rptrekaplabarugi()
        rpt.Site = Me.Site
        Return rpt
    End Function
