...
Public Class fakturkasmasuk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturkasmasuk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfakturkasmasuk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturkasmasuk = New fakturkasmasuk()
        rpt.Site = Me.Site
        Return rpt
    End Function
