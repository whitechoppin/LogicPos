...
Public Class rptperfakturjualpajak
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptperfakturjualpajak.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptperfakturjualpajak.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptperfakturjualpajak
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptperfakturjualpajak = New rptperfakturjualpajak()
        rpt.Site = Me.Site
        Return rpt
    End Function
