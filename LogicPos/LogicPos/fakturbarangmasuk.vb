...
Public Class fakturbarangmasuk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturbarangmasuk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfakturbarangmasuk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturbarangmasuk = New fakturbarangmasuk()
        rpt.Site = Me.Site
        Return rpt
    End Function
