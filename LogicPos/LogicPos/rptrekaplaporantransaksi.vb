...
Public Class rptrekaplaporantransaksi
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptrekaplaporantransaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptrekaplaporantransaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptrekaplaporantransaksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrekaplaporantransaksi = New rptrekaplaporantransaksi()
        rpt.Site = Me.Site
        Return rpt
    End Function
