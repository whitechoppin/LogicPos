        ...
        Else
            Try
                ...
                For i As Integer = 0 To GridView1.RowCount - 1
                    myCommand.CommandText = "INSERT INTO tb_pengiriman_detail (kode_pengiriman, kode_barang, nama_barang, panjang_barang, lebar_barang, tinggi_barang, volume_barang, qty, total_volume, harga_barang, ongkos_kirim, total_ongkos_kirim, total_harga_barang, grand_total_barang, created_by, updated_by, date_created, last_updated) VALUES ('" & kodepengiriman & "','" & GridView1.GetRowCellValue(i, "kode_barang") & "', '" & GridView1.GetRowCellValue(i, "nama_barang") & "','" & GridView1.GetRowCellValue(i, "panjang_barang") & "','" & GridView1.GetRowCellValue(i, "lebar_barang") & "','" & GridView1.GetRowCellValue(i, "tinggi_barang") & "','" & GridView1.GetRowCellValue(i, "volume_barang") & "','" & GridView1.GetRowCellValue(i, "qty") & "','" & GridView1.GetRowCellValue(i, "total_volume") & "', '" & GridView1.GetRowCellValue(i, "harga_barang") & "','" & GridView1.GetRowCellValue(i, "ongkos_kirim") & "','" & GridView1.GetRowCellValue(i, "total_ongkos_kirim") & "','" & GridView1.GetRowCellValue(i, "total_harga_barang") & "','" & GridView1.GetRowCellValue(i, "grand_total_barang") & "','" & fmenu.namauser.Text & "','" & fmenu.namauser.Text & "',now(),now())"
    ...
    Sub perbarui(nomornota As String)
        ...
        Else
            Try
                ...
                myCommand.CommandText = "UPDATE tb_pengiriman SET kode_user = '" & cmbuser.Text & "', nama_expedisi = '" & txtnamaexpedisi.Text & "', alamat_expedisi = '" & txtalamatexpedisi.Text & "', telp_expedisi = '" & txttelpexpedisi.Text & "', tgl_pengiriman = '" & Format(dtpengiriman.Value, "yyyy-MM-dd HH:mm:ss") & "', total_pengiriman='" & totalongkospengiriman & "', print_pengiriman = 0, posted_pengiriman = 1, keterangan_pengiriman = '" & txtketerangan.Text & "', updated_by = '" & fmenu.namauser.Text & "', last_updated = now() WHERE kode_pengiriman = '" & nomornota & "' "
                myCommand.ExecuteNonQuery()
