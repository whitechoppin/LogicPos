...
Public Class rptlapormodal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptlapormodal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlapormodal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlapormodal = New rptlapormodal()
        rpt.Site = Me.Site
        Return rpt
    End Function
