...
Public Class flaporanpembelian
    Public namaform As String = "laporan-pembelian"
    ...
    Private Sub flaporanpembelian_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Call historysave("Membuka Laporan Pembelian", "N/A", namaform)
    End Sub
    Sub grid()
    ...
    Sub tabel()
        ...
        Else
            sql = "SELECT * FROM tb_pembelian_detail JOIN tb_pembelian ON tb_pembelian.id = tb_pembelian_detail.pembelian_id JOIN tb_supplier ON tb_supplier.id = tb_pembelian.supplier_id JOIN tb_user ON tb_user.id = tb_pembelian.user_id WHERE DATE(tgl_pembelian) BETWEEN '" & Format(DateTimePicker1.Value, "yyyy-MM-dd") & "' AND '" & Format(DateTimePicker2.Value, "yyyy-MM-dd") & "' ORDER BY tb_pembelian.id ASC"
        End If
    ...
    Private Sub btnrekap_Click(sender As Object, e As EventArgs) Handles btnrekap.Click
        If printstatus.Equals(True) Then
            ...
            Else
                sql = "SELECT * FROM tb_pembelian WHERE DATE(tgl_pembelian) BETWEEN '" & Format(DateTimePicker1.Value, "yyyy-MM-dd") & "' AND '" & Format(DateTimePicker2.Value, "yyyy-MM-dd") & "'"
            End If
            ...
            If dr.HasRows Then
                ...
                flappembelian.CrystalReportViewer.ReportSource = rptrekap
                flappembelian.ShowDialog()
                flappembelian.WindowState = FormWindowState.Maximized

                Call historysave("Merekap Faktur Laporan Pembelian", "N/A", namaform)
            Else
    ...
    Private Sub btntabel_Click(sender As Object, e As EventArgs) Handles btntabel.Click
        Call tabel()
        Call historysave("Merefresh Laporan Pembelian", "N/A", namaform)
    End Sub
    Sub ExportToExcel()
    ...
    Private Sub btnexcel_Click(sender As Object, e As EventArgs) Handles btnexcel.Click
        If exportstatus.Equals(True) Then
            If GridView1.DataRowCount > 0 Then
                ...
                Call historysave("Mengexport Laporan Pembelian", "N/A", namaform)
            Else
    ...
    Private Sub btnperfaktur_Click(sender As Object, e As EventArgs) Handles btnperfaktur.Click
        If printstatus.Equals(True) Then
            ...
            If dr.HasRows Then
                ...
                Call historysave("Merekap Faktur Detail Laporan Pembelian", "N/A", namaform)
            Else
                MsgBox("Data pada tanggal tersebut tidak tersedia", MsgBoxStyle.Information, "Pemberitahuan")
            End If
        Else
    ...
    Private Sub btnrekappembelianbarang_Click(sender As Object, e As EventArgs) Handles btnrekappembelianbarang.Click
        If printstatus.Equals(True) Then
            Dim rptrekap As ReportDocument
            Dim awalPFDs As ParameterFieldDefinitions
            Dim awalPFD As ParameterFieldDefinition
            ...
            If dr.HasRows Then
                rptrekap = New rptrekappembelianbarang
                ...
                Call historysave("Merekap Laporan Pembelian Barang", "N/A", namaform)
            Else
                MsgBox("Data pada tanggal tersebut tidak tersedia", MsgBoxStyle.Information, "Pemberitahuan")
            End If
        Else
