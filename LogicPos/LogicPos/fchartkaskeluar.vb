...
Public Class fchartkaskeluar
    Public namaform As String = "chart-kas_keluar"
    ...
    Private Sub fchartkaskeluar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.MdiParent = fmenu
        ...
        Call historysave("Membuka Chart Kas Keluar", "N/A", namaform)
    End Sub
    ...
    Private Sub btnexcel_Click(sender As Object, e As EventArgs) Handles btnexcel.Click
        If exportstatus.Equals(True) Then
            ExportToExcel()
            Call historysave("Mengexport Chart Kas Keluar", "N/A", namaform)
        Else
