...
Public Class fakturkaskeluar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturkaskeluar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kodekas() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedfakturkaskeluar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturkaskeluar = New fakturkaskeluar()
        rpt.Site = Me.Site
        Return rpt
    End Function
