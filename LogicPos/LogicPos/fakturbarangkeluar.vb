...
Public Class fakturbarangkeluar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.fakturbarangkeluar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfakturbarangkeluar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fakturbarangkeluar = New fakturbarangkeluar()
        rpt.Site = Me.Site
        Return rpt
    End Function
