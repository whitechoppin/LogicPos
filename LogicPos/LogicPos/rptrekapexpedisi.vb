...
Public Class rptrekapexpedisi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptrekapexpedisi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptrekapexpedisi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrekapexpedisi = New rptrekapexpedisi()
        rpt.Site = Me.Site
        Return rpt
    End Function
