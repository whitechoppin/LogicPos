...
Public Class flaporankas
    ...
    Private Sub flaporankaskeluar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        With GridView1
            ...
            'buat sum harga
            .Columns("kas_masuk").Summary.Add(DevExpress.Data.SummaryItemType.Sum, "kas_masuk", "{0:n0}")
            .Columns("kas_keluar").Summary.Add(DevExpress.Data.SummaryItemType.Sum, "kas_keluar", "{0:n0}")
    ...
    Sub grid()
        ...
        GridColumn6.FieldName = "kas_masuk"

        GridColumn7.Caption = "Kredit"
        GridColumn7.FieldName = "kas_keluar"
