...
Public Class rptrekaplunaspiutang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptrekaplunaspiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptrekaplunaspiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptrekaplunaspiutang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrekaplunaspiutang = New rptrekaplunaspiutang()
        rpt.Site = Me.Site
        Return rpt
    End Function
