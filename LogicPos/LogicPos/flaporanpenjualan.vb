...
Public Class flaporanpenjualan
    ...
    Sub tabel()
        ...
        Else
            sql = "SELECT * FROM tb_penjualan_detail JOIN tb_penjualan On tb_penjualan.id = tb_penjualan_detail.penjualan_id JOIN tb_pelanggan On tb_pelanggan.id =tb_penjualan.pelanggan_id JOIN tb_user ON tb_user.id = tb_penjualan.user_id WHERE DATE(tgl_penjualan) BETWEEN '" & Format(DateTimePicker1.Value, "yyyy-MM-dd") & "' AND '" & Format(DateTimePicker2.Value, "yyyy-MM-dd") & "' ORDER BY tb_penjualan.id ASC"
        End If
    ...
    Private Sub btnrekap_Click(sender As Object, e As EventArgs) Handles btnrekap.Click
        If printstatus.Equals(True) Then
            ...
            If dr.HasRows Then
                ...
                flappenjualan.CrystalReportViewer.ReportSource = rptrekap
