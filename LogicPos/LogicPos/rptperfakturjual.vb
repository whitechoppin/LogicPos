...
Public Class rptperfakturjual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LogicPos.rptperfakturjual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptperfakturjual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptperfakturjual = New rptperfakturjual()
        rpt.Site = Me.Site
        Return rpt
    End Function
